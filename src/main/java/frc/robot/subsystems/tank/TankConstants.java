...
public class TankConstants {
    ...
    static final WPI_TalonSRX LEFT_MOTOR_2 = new WPI_TalonSRX(LEFT_MOTOR_2_ID);
    static final WPI_TalonSRX RIGHT_MOTOR_1= new WPI_TalonSRX(RIGHT_MOTOR_1_ID);
    static final WPI_TalonSRX RIGHT_MOTOR_2 = new WPI_TalonSRX(RIGHT_MOTOR_2_ID);

    static final DifferentialDrive DIFFERENTIAL_DRIVE = new DifferentialDrive(LEFT_MOTOR_1, RIGHT_MOTOR_1);
    ...
    private static void configLeftMotors() {
        ...
        LEFT_MOTOR_1.setNeutralMode(NEUTRAL_MODE);
        LEFT_MOTOR_2.setNeutralMode(NEUTRAL_MODE);
    ...
    private static void configRightMotors() {
        ...
        RIGHT_MOTOR_1.setNeutralMode(NEUTRAL_MODE);
        RIGHT_MOTOR_2.setNeutralMode(NEUTRAL_MODE);
